...
public class ProfileZipSlip extends ProfileUploadBase {
  ...
  @ResponseBody
  public AttackResult uploadFileHandler(@RequestParam("uploadedFileZipSlip") MultipartFile file) { // PathTraversal
  ...
  private AttackResult processZipUpload(MultipartFile file) {
    ...
    try {
      var uploadedZipFile = tmpZipDirectory.resolve(file.getOriginalFilename()); // $cwe-22
