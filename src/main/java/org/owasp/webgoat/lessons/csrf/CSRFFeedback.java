...
public class CSRFFeedback extends AssignmentEndpoint {
  ...
  @ResponseBody
  public AttackResult completed(HttpServletRequest request, @RequestBody String feedback) { // 检查 feedback 是否为正确的 json 并且 Content-Type 为 text/plain 并且 referer 校验不通过, 成功则返回 flag
    try {
  ...
  @ResponseBody
  public AttackResult flag(@RequestParam("confirmFlagVal") String flag) { // 提交 flag 的接口
